...
여기에 **탐색 기준 다이얼**로 취향을 얹을 수 있습니다 — 선택지 멘트는 위트 있게, 실제로는 AI 프롬프트에 주입돼 결과를 좁힙니다.

| 다이얼 | 선택지 (멘트) |
|---|---|
| **RISK** | 안전빵 *"잠은 자야지"* · 밸런스 · 한 방 *"상폐 아니면 텐배거"* |
| **SIZE** | 대형 *"이미 큰 코끼리"* · 중형 · 소형 *"흙 속 진주"* · 마이크로 *"검색하면 직원이 댓글 다는 곳"* |
| **TERM** | 단타 *"지금 당장 뜨거운"* · 중기 · 장투 *"손주에게 물려줄"* |
| **BUZZ** | 핫템 *"유튜버가 다 떰"* · 역발상 *"아무도 안 볼 때 줍줍"* |
