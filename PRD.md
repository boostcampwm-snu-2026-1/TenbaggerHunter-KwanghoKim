...
Tenbagger Hunter는 AI 기반 글로벌 주식 리서치 어시스턴트다. 단순한 스크리너가 아니라, 사용자가 입력한 테마나 키워드를 바탕으로 10배 상승 가능성이 있는 기업 후보를 발굴하고, 왜 그 기업인지 내러티브와 데이터를 통합해 설명해주는 도구다.
